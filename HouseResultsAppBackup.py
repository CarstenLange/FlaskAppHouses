...
# The HTML interface with hidden inputs to preserve your initial URL dictionary
HTML_FORM = """
<!DOCTYPE html>
<html>
<head><title>Select House Features</title></head>
<body>
    <h2>Select House Specifications</h2>
...
def FctSHAPResults():
    ...
    return render_template("ResultsOLS.html", PredPrice=float(ExplainerOLSWithPCAs.model.predict(DataUserFinal)[0]), 
